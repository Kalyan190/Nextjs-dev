...
const PriceCard = ({time,price}:Props) => {
  return (
    <div className='bg-white rounded-lg p-8 relative border-t-4 border-rose-300'>
      ...
      <p className='mt-4 text-gray-600 font-medium'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, sunt.</p>
      <div className='mt-8 '>
           <div className='text-gray-700 font-semibold text-lg '>
             <span className='text-4xl text-black font-bold'>${price}</span> / Month
           </div>
      </div>
      <div className='mt-12'>
